...
| Taste and craft | Brief inference, direction, anti-template decisions, typography, composition, imagery, copy, final craft floor | `direction-and-taste.md`, `design-and-brand.md` |
...
| UI/UX pattern intelligence | Surface classification, stack-aware component choices, design-system routing, typography and palette candidates, UX heuristics, and implementation checks | `systems-and-product-ui.md` |
| Interaction craft | Motion purpose, timing, easing, interruption, hover/focus/active feel, optimistic feedback, direct manipulation, and micro-behavior polish | `implementation-and-interaction.md` |
...
| Portable design specifications | Semantic tokens, themes, components, state rules, schema validation, and migration evidence | `prototyping-and-rich-media.md`, `systems-and-product-ui.md` |
...
| Accessibility | Semantics, keyboard, focus, zoom, touch, contrast, motion preferences, forced colors, and assistive-state completeness | `responsive-and-accessibility.md` |
...
| Dogfood | Primary journeys, failure and recovery, history navigation, touch, keyboard, and visitor-perspective defects | `release-contract.md` |
